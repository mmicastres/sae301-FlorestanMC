...
class ProjetController {
	...
	*/	
	public function listeMesProjets($idutilisateur) {
		$ressources = $this->projManager->getRessourcesProjet($idutilisateur);
		$projets = $this->projManager->getProjetsMembre($idutilisateur);
		echo $this->twig->render('mesprojets_liste.html.twig',array('ressources'=>$ressources,'projs'=>$projets,'acces'=> $_SESSION['acces'],'admin'=> $_SESSION['admin'])); 
	  }
